...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(
    'Run symbol flipping on a problem instance to find '
  ...
  binary_search_results = bp.binary_search(
    H, p, args.max_error_rate, args.num_shots,
    bp.sample_and_decode_shots_symbolflipping, verbose=args.verbose)
